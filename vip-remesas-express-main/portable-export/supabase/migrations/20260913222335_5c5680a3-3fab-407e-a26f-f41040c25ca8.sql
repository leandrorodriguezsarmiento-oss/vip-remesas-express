...
DECLARE
  ...
  v_url text := coalesce(current_setting('app.settings.dispatch_url', true), 'https://tudominio.com/api/public/push/dispatch');
BEGIN
...
DECLARE
  ...
  v_anon_key text := current_setting('app.settings.anon_key', true);
  v_dispatch_url text := coalesce(current_setting('app.settings.dispatch_url', true), 'https://tudominio.com/api/public/push/dispatch');
BEGIN
