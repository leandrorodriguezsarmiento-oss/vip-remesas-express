...
DECLARE
  ...
  v_url text := coalesce(current_setting('app.settings.dispatch_url', true), 'https://project--f318d839-9858-4e78-a02b-1da8134720f0.lovable.app/api/public/push/dispatch');
BEGIN
...
DECLARE
  ...
  v_anon_key text := current_setting('app.settings.anon_key', true);
  v_dispatch_url text := coalesce(current_setting('app.settings.dispatch_url', true), 'https://project--f318d839-9858-4e78-a02b-1da8134720f0.lovable.app/api/public/push/dispatch');
BEGIN
