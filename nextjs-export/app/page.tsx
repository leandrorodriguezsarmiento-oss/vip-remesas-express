  ...
  return (
    <div className="min-h-screen bg-gradient-vip text-foreground">
      <header className="mx-auto flex max-w-md items-center justify-between px-5 pt-6">
        ...
        <Link href="/auth" className="text-sm font-medium text-gold hover:opacity-80">Entrar</Link>
      </header>
      ...
      <main className="mx-auto max-w-md px-5 pt-14 pb-16">
        ...
        <div className="mt-8 space-y-3">
          <Link href="/auth" className="block w-full rounded-xl bg-gradient-gold px-6 py-4 text-center text-base font-semibold text-primary-foreground shadow-gold">
            Crear cuenta gratis
          </Link>
          <Link href="/auth" className="block w-full rounded-xl border border-gold/50 bg-card/50 px-6 py-4 text-center text-base font-medium text-foreground">
            Ya tengo cuenta
          </Link>
        </div>
        ...
        <div className="mt-12 grid grid-cols-2 gap-3">
          {[
            ...
            { icon: Globe2, title: "3 orígenes", desc: "BR · EU · US" },
